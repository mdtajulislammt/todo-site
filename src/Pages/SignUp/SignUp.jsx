    ...
    <div
      ...
      <div className="md:w-8/12 lg:ml-6 lg:w-4/12 p-4 rounded-lg border-2 shadow-lg bg-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* <!-- Submit button --> */}
          <input type="submit" value="SignUp" className="  border-2 border-[#5c85ef] bg-[#5c85ef] flex gap-2 items-center justify-center w-full mb-5 rounded  py-2.5 px-5 font-medium uppercase text-gray-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-y-0 before:bg-[#5c85ef] before:transition-transform before:duration-300 before:content-[''] hover:text-white cursor-pointer before:hover:scale-y-100" />
