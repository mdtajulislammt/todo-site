...
const HeroSection = () => {
     return (
          <div className=" bg-black md:h-screen lg:px-12 md:px-12 px-10 lg:pt-40 md:pt-32 pt-20 " id='box'>
          <div className=" " >
  <div className="hero-overlay "></div>
  <div className="md:flex md:flex-row-reverse  justify-between pb-20 md:pb-0 ">
  <div><img src={banner} alt="" className=' drop-s object-cover md:w-[450px] mx-auto w-[250px] mr-14 lg:-mt-10' /></div>
